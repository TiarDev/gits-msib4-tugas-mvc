...
<html lang="en">
  ...
  <body>
    <div class="container mt-5">
        <h1 class="text-center mb-3">Form Edit Data Mahasiswa</h1>

        <a href="{{ route('mahasiswa.index') }}" class="btn btn-secondary btn-sm m-2"><i class="bi bi-arrow-left"></i>kembali</a>
